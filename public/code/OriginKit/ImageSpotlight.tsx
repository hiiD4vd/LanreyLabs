...
function __OriginkitBase_SpotlightReveal(props: SpotlightRevealProps) {
    const {
        image = {
            src: DEFAULT_IMAGE,
        },
...
export default function SpotlightReveal(props: Record<string, unknown>) {
  return <__OriginkitBase_SpotlightReveal {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
