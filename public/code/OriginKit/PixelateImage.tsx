 ...
 */
function __OriginkitBase_PixelateComponent(props: any) {
...
export default function PixelateComponent(props: Record<string, unknown>) {
  return <__OriginkitBase_PixelateComponent {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
